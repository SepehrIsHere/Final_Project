...
public class DeleteOrderTest {
    ...
    Order generateValidOrder(){
        SubTask subTask = new SubTask("test subtask",1000000.0,"test subtask description",new Task("test task name","test task description"));
    ...
    Order generateInvalidOrder(){
        SubTask subTask = new SubTask("test subtask",50000.0,"test subtask description",new Task("test task name","test task description"));
        return Order.builder().
                suggestedPrice(1000000.0).
                dateOfService(LocalDate.of(2020, Month.APRIL,12)).
                subTask(subTask).build();
